...
-   It is important to note that **you can only start the operation again using the specific sequence**: 1) Release the E-Stop/ Door Guard 2) Confirm on the display 3) Start Button. This gives another safety to the overall system.
  ...
  - The button colors of CR1140 indicate the current state of the system: <span style="color:green;">running</span>, <font color="orange">idle</font>, <font color="red">safety critical state</font> and <font color="red">confirmation required</font>.
